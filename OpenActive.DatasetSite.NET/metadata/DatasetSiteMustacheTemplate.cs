    ...
    <div id=""wrapper"" typeof=""dcat:Dataset"" resource=""{{url}}"">
        ...
        <section id=""main"">
            <header>
                ...
                <p class=""description"">Near real-time availability and rich descriptions of the sessions and facilities available from {{publisher.name}}, published using <a href='https://www.openactive.io/'>OpenActive</a> <a href='https://www.openactive.io/realtime-paged-data-exchange/1.0/'>RPDE 1.0</a> and <a href='{{schemaVersion}}'>Model 2.0</a>.</p>
        ...
        <footer id=""footer"">
            <ul class=""copyright"">
                <li>Platform: <a href=""{{bookingService.url}}"">{{bookingService.name}} {{bookingService.softwareVersion}}</a>. Design: <a href=""http://html5up.net"">HTML5 UP</a>.</li>
            </ul>
        </footer>
