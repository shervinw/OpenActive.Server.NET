...
namespace OpenActive.Server.NET.StoreBooking
{
    ...
    {
        void SetConfiguration(IBookablePairIdTemplate template);
        /*
    ...
    {
        public void SetConfiguration(IBookablePairIdTemplate template)
        {
            ...
            base.SetConfiguration((BookablePairIdTemplate<TComponents>)template);
        }
